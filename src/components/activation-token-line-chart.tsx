...
import { activationTokenLineChartData, activationTokenLineChartConfig } from "@/mocks/chart-data"
...
export const ActivationTokenLineChart = memo(function ActivationTokenLineChart({ onTokenHover, onTokenLeave }: ActivationTokenLineChartProps) {
